...
*PlaylistEditor 
*/
function sortByName(tracks, order) {
...
function sortByOriginalPostion(tracks, order) {
  return tracks.sort((a, b) => {
...
function sortByAlbumName(tracks, order) {
  return tracks.sort((a, b) => {
...
function sortByArtistName(tracks, order) {
  return tracks.sort((a, b) => {
...
function sortByRelease(tracks, order) {
  return tracks.sort((a, b) => {
...
function sortByPopularity(tracks, order) {
  return tracks.sort((a, b) => {
...
function sortByDateAdded(tracks, order) {
  return tracks.sort((a, b) => {
...
function sortByTempo(tracks, order) {
  return tracks.sort((a, b) => {
...
function sortByAcousticness(tracks, order) {
  return tracks.sort((a, b) => {
...
function sortByDanceability(tracks, order) {
  return tracks.sort((a, b) => {
...
function sortByEnergy(tracks, order) {
  return tracks.sort((a, b) => {
...
function sortByInstrumentalness(tracks, order) {
  return tracks.sort((a, b) => {
...
function sortByLiveness(tracks, order) {
  return tracks.sort((a, b) => {
...
function sortByLoudness(tracks, order) {
  return tracks.sort((a, b) => {
...
function sortBySpeechiness(tracks, order) {
  return tracks.sort((a, b) => {
...
function sortByValence(tracks, order) {
  return tracks.sort((a, b) => {
...
export const Sorters = {
  'name': sortByName,
  'original_position': sortByOriginalPostion,
  'album_name': sortByAlbumName,
  'artist_name': sortByArtistName,
  'release_date': sortByRelease,
  'popularity': sortByPopularity,
  'date_added': sortByDateAdded,
  'tempo': sortByTempo,
  'acousticness': sortByAcousticness,
  'danceability': sortByDanceability,
  'energy': sortByEnergy,
  'instrumentalness': sortByInstrumentalness,
  'liveness': sortByLiveness,
  'loudness': sortByLoudness,
  'speechiness': sortBySpeechiness,
  'valence': sortByValence,
};
